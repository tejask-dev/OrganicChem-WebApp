...
exports.resetExtensions = resetExtensions;
...
function createExtensions(gl) {
    ...
    const renderSnorm = (0, compat_1.getRenderSnorm)(gl);
    if (debug_1.isDebugMode && renderSnorm === null) {
        console.log('Could not find support for "render_snorm"');
    }
    const renderSharedExponent = (0, compat_1.getRenderSharedExponent)(gl);
    if (debug_1.isDebugMode && renderSharedExponent === null) {
        console.log('Could not find support for "render_shared_exponent"');
    }
    const textureNorm16 = (0, compat_1.getTextureNorm16)(gl);
    if (debug_1.isDebugMode && textureNorm16 === null) {
        console.log('Could not find support for "texture_norm16"');
    }
    const depthClamp = (0, compat_1.getDepthClamp)(gl);
    if (debug_1.isDebugMode && depthClamp === null) {
