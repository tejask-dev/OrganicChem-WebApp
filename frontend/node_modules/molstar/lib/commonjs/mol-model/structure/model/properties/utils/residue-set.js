...
class ResidueSet {
    ...
    static getEntryFromLocation(loc) {
        var _a;
        return {
            label_asym_id: properties_1.StructureProperties.chain.label_asym_id(loc),
            label_comp_id: properties_1.StructureProperties.atom.label_comp_id(loc),
            label_seq_id: properties_1.StructureProperties.residue.label_seq_id(loc),
            label_alt_id: properties_1.StructureProperties.atom.label_alt_id(loc),
            ins_code: properties_1.StructureProperties.residue.pdbx_PDB_ins_code(loc),
            operator_name: (_a = properties_1.StructureProperties.unit.operator_name(loc)) !== null && _a !== void 0 ? _a : '1_555'
        };
    }
    _find(entry, xs) {
        var _a, _b;
    ...
    constructor(options) {
        ...
        this._asym_id = properties_1.StructureProperties.chain.label_asym_id;
        this._seq_id = properties_1.StructureProperties.residue.label_seq_id;
        this._comp_id = properties_1.StructureProperties.atom.label_comp_id;
        this._alt_id = properties_1.StructureProperties.atom.label_alt_id;
        this._ins_code = properties_1.StructureProperties.residue.pdbx_PDB_ins_code;
        this._op_name = properties_1.StructureProperties.unit.operator_name;
