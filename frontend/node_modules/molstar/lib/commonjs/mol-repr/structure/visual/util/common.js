...
function getConformation(unit) {
    switch (unit.kind) {
        case structure_1.Unit.Kind.Atomic: return unit.model.atomicConformation;
        case structure_1.Unit.Kind.Spheres: return unit.model.coarseConformation.spheres;
        case structure_1.Unit.Kind.Gaussians: return unit.model.coarseConformation.gaussians;
    }
}
