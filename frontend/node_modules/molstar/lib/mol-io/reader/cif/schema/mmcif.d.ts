...
export declare const mmCIF_Schema: {
    /**
    ...
    atom_site: {
         ...
         */
        group_PDB: Schema.Aliased<"ATOM" | "HETATM">;
        /**
    ...
    atom_site_anisotrop: {
         ...
         */
        pdbx_label_seq_id: Schema.Int;
        /**
         * Pointer to _atom_site.label_alt_id.
         */
        pdbx_label_alt_id: Schema.Str;
        /**
         * Pointer to _atom_site.label_asym_id
         */
        pdbx_label_asym_id: Schema.Str;
        /**
         * Pointer to _atom_site.label_atom_id
         */
        pdbx_label_atom_id: Schema.Str;
        /**
         * Pointer to _atom_site.label_comp_id
         */
        pdbx_label_comp_id: Schema.Str;
        /**
    ...
    atom_sites: {
         ...
         * |z'|               |31 32 33| |z|              |3|
         */
        fract_transf_matrix: Schema.Tensor;
        /**
         ...
         * |z'|               |31 32 33| |z|              |3|
         */
        fract_transf_vector: Schema.Tensor;
    };
    /**
    ...
    database_2: {
         ...
         */
        database_id: Schema.Aliased<"alphafolddb" | "cas" | "csd" | "emdb" | "icsd" | "modelarchive" | "mdf" | "modbase" | "ndb" | "nbs" | "pdb" | "pdb-dev" | "pdf" | "rcsb" | "swiss-model_repository" | "ebi" | "pdbe" | "bmrb" | "wwpdb" | "pdb_acc">;
        /**
         * The code assigned by the database identified in
         * _database_2.database_id.
         */
        database_code: Schema.Str;
    };
    /**
    ...
    entity: {
         ...
         */
        src_method: Schema.Aliased<"nat" | "man" | "syn">;
        /**
         ...
         */
        pdbx_description: Schema.List<string>;
        /**
    ...
    entity_poly: {
         ...
         */
        type: Schema.Aliased<"other" | "polypeptide(D)" | "polypeptide(L)" | "polydeoxyribonucleotide" | "polyribonucleotide" | "polydeoxyribonucleotide/polyribonucleotide hybrid" | "cyclic-pseudo-peptide" | "peptide nucleic acid">;
        /**
         * The PDB strand/chain id(s) corresponding to this polymer entity.
         */
        pdbx_strand_id: Schema.List<string>;
        /**
    ...
    struct: {
         ...
         */
        pdbx_structure_determination_methodology: Schema.Aliased<"experimental" | "integrative" | "computational">;
        /**
    ...
    struct_conn: {
         ...
         */
        conn_type_id: Schema.Aliased<"covale" | "disulf" | "metalc" | "hydrog">;
        /**
         ...
         * ATOM_SITE category.
         */
        ptnr1_label_asym_id: Schema.Str;
        /**
         * A component of the identifier for partner 1 of the structure
         * connection.
         *
         ...
         * CHEM_COMP_ATOM category.
         */
        ptnr1_label_atom_id: Schema.Str;
        /**
         * A component of the identifier for partner 1 of the structure
         * connection.
         *
         ...
         * ATOM_SITE category.
         */
        ptnr1_label_comp_id: Schema.Str;
        /**
         * A component of the identifier for partner 1 of the structure
         * connection.
         *
         ...
         * ATOM_SITE category.
         */
        ptnr2_label_asym_id: Schema.Str;
        /**
         * A component of the identifier for partner 2 of the structure
         * connection.
         *
         ...
         * CHEM_COMP_ATOM category.
         */
        ptnr2_label_atom_id: Schema.Str;
        /**
         * A component of the identifier for partner 2 of the structure
         * connection.
         *
         ...
         * ATOM_SITE category.
         */
        ptnr2_label_comp_id: Schema.Str;
        /**
         * A component of the identifier for partner 2 of the structure
         * connection.
         *
         ...
         * ATOM_SITE category.
         */
        pdbx_ptnr1_PDB_ins_code: Schema.Str;
        /**
    ...
    struct_conn_type: {
         ...
         */
        id: Schema.Aliased<"covale" | "disulf" | "metalc" | "hydrog" | "mismat" | "saltbr" | "modres" | "covale_base" | "covale_sugar" | "covale_phosphate">;
        /**
         * A reference that specifies the criteria used to define the
         * interaction.
         */
        reference: Schema.Str;
    };
    /**
    ...
    struct_mon_prot_cis: {
         ...
         * Pointer to _atom_site.auth_asym_id.
         */
        pdbx_auth_asym_id_2: Schema.Str;
        /**
         * Pointer to _atom_site.auth_comp_id.
         */
        pdbx_auth_comp_id_2: Schema.Str;
        /**
         * Pointer to _atom_site.auth_seq_id
         */
        pdbx_auth_seq_id_2: Schema.Int;
        /**
         * Pointer to _atom_site.label_asym_id.
         */
        pdbx_label_asym_id_2: Schema.Str;
        /**
         * Pointer to _atom_site.label_comp_id.
         */
        pdbx_label_comp_id_2: Schema.Str;
        /**
         * Pointer to _atom_site.label_seq_id
         */
        pdbx_label_seq_id_2: Schema.Int;
        /**
         * Pointer to _atom_site.pdbx_PDB_ins_code
         */
        pdbx_PDB_ins_code: Schema.Str;
         ...
         * Pointer to _atom_site.pdbx_PDB_ins_code
         */
        pdbx_PDB_ins_code_2: Schema.Str;
        /**
         ...
         * PDB Insertion code
         */
        pdbx_auth_ins_code: Schema.Str;
        /**
         * PDB Insertion code
         */
        pdbx_auth_ins_code_2: Schema.Str;
    };
    /**
    ...
    struct_site: {
         ...
         */
        pdbx_num_residues: Schema.Int;
        /**
         * Source of evidence supporting the assignment of this site.
         */
        pdbx_evidence_code: Schema.Str;
        /**
    ...
    symmetry: {
         ...
         */
        cell_setting: Schema.Aliased<"triclinic" | "monoclinic" | "orthorhombic" | "tetragonal" | "rhombohedral" | "trigonal" | "hexagonal" | "cubic">;
        /**
         * Space-group number from International Tables for Crystallography
         * Vol. A (2002).
         */
        Int_Tables_number: Schema.Int;
        /**
         ...
         * (1981) A37, 921.
         */
        space_group_name_Hall: Schema.Str;
        /**
         ...
         * different axes.
         */
        'space_group_name_H-M': Schema.Str;
    };
    /**
    ...
    pdbx_database_status: {
         ...
         */
        status_code: Schema.Aliased<"PROC" | "WAIT" | "REL" | "HOLD" | "HPUB" | "REFI" | "OBS" | "WDRN" | "AUTH" | "POLC" | "REPL" | "AUCO" | "TRSF" | "RMVD" | "DEL" | "REV" | "UPD" | "BIB">;
        /**
         * Code for status of structure factor file.
         */
        status_code_sf: Schema.Aliased<"PROC" | "WAIT" | "REL" | "HOLD" | "HPUB" | "OBS" | "WDRN" | "AUTH" | "POLC" | "REPL" | "RMVD">;
        /**
         * Code for status of NMR constraints file.
         */
        status_code_mr: Schema.Aliased<"PROC" | "WAIT" | "REL" | "HOLD" | "HPUB" | "OBS" | "WDRN" | "AUTH" | "POLC" | "REPL" | "AUCO" | "RMVD">;
        /**
         ...
         */
        recvd_initial_deposition_date: Schema.Str;
        /**
         ...
         */
        status_code_cs: Schema.Aliased<"PROC" | "WAIT" | "REL" | "HOLD" | "HPUB" | "OBS" | "WDRN" | "AUTH" | "POLC" | "REPL" | "AUCO" | "RMVD">;
        /**
         * The methods development category in which this
         * entry has been placed.
         */
        methods_development_category: Schema.Aliased<"CAPRI" | "CASP" | "CASD-NMR" | "FoldIt" | "GPCR Dock" | "D3R" | "RNA-Puzzles">;
        /**
    ...
    pdbx_nonpoly_scheme: {
         ...
         * PDB strand/chain id.
         */
        pdb_strand_id: Schema.Str;
        /**
         * NDB/RCSB residue number.
         */
        ndb_seq_num: Schema.Str;
        /**
         * PDB residue number.
         */
        pdb_seq_num: Schema.Str;
        /**
         ...
         */
        auth_seq_num: Schema.Str;
        /**
         * PDB residue identifier.
         */
        pdb_mon_id: Schema.Str;
        /**
    ...
    pdbx_database_related: {
         ...
         */
        db_name: Schema.Aliased<"NDB" | "BMRB" | "BIOISIS" | "BMCD" | "EMDB" | "PDB" | "PDB-Dev" | "SASBDB" | "TargetDB" | "TargetTrack">;
        /**
    ...
    entity_src_gen: {
         ...
         * Identifies the gene.
         */
        pdbx_gene_src_gene: Schema.List<string>;
        /**
         * Scientific name of the organism.
         */
        pdbx_gene_src_scientific_name: Schema.Str;
        /**
    ...
    pdbx_entity_branch_link: {
         ...
         * in the PDBX_ENTITY_BRANCH_LIST category.
         */
        entity_branch_list_num_1: Schema.Int;
        /**
         ...
         * in the PDBX_ENTITY_BRANCH_LIST category.
         */
        entity_branch_list_num_2: Schema.Int;
        /**
    ...
    pdbx_entity_branch: {
         ...
         */
        type: Schema.Aliased<"oligosaccharide">;
    };
    /**
    ...
    pdbx_chem_comp_related: {
         ...
         */
        related_comp_id: Schema.Str;
        /**
         * Describes the type of relationship
         */
        relationship_type: Schema.Aliased<"Carbohydrate core" | "Precursor">;
        /**
         * Describes the type of relationship
         */
        details: Schema.Str;
    ...
    ihm_starting_model_details: {
         ...
         */
        entity_poly_segment_id: Schema.Int;
        /**
         * The source of the starting model.
         */
        starting_model_source: Schema.Aliased<"other" | "comparative model" | "experimental model" | "integrative model" | "ab initio model">;
        /**
         ...
         */
        starting_model_auth_asym_id: Schema.Str;
        /**
         ...
         */
        starting_model_sequence_offset: Schema.Int;
        /**
    ...
    ihm_starting_comparative_models: {
         ...
         */
        template_sequence_identity_denominator: Schema.Aliased<"1" | "2" | "3" | "4" | "5">;
        /**
         ...
         */
        template_dataset_list_id: Schema.Int;
        /**
    ...
    ihm_ensemble_info: {
         ...
         */
        ensemble_clustering_method: Schema.Aliased<"Hierarchical" | "Partitioning (k-means)" | "Density based threshold-clustering" | "Other">;
        /**
         * The parameter/feature used for clustering the models, if applicable.
         */
        ensemble_clustering_feature: Schema.Aliased<"other" | "RMSD" | "dRMSD">;
        /**
         * The number of models in the current ensemble being described.
         */
        num_ensemble_models: Schema.Int;
        /**
         * The number of models from the current ensemble that is deposited.
         */
        num_ensemble_models_deposited: Schema.Int;
        /**
         ...
         */
        ensemble_precision_value: Schema.Float;
        /**
    ...
    ihm_model_representative: {
         ...
         */
        selection_criteria: Schema.Aliased<"minimized average structure" | "medoid" | "closest to the average" | "lowest energy" | "target function" | "fewest violations" | "best scoring model" | "centroid" | "other selction criteria">;
    };
    /**
    ...
    ihm_dataset_list: {
         ...
         */
        data_type: Schema.Aliased<"Other" | "NMR data" | "3DEM volume" | "2DEM class average" | "EM raw micrographs" | "X-ray diffraction data" | "SAS data" | "CX-MS data" | "Crosslinking-MS data" | "Mass Spectrometry data" | "EPR data" | "H/D exchange data" | "Single molecule FRET data" | "Ensemble FRET data" | "Experimental model" | "Comparative model" | "Integrative model" | "De Novo model" | "Predicted contacts" | "Mutagenesis data" | "DNA footprinting data" | "Hydroxyl radical footprinting data" | "Yeast two-hybrid screening data" | "Quantitative measurements of genetic interactions">;
        /**
    ...
    ihm_dataset_group: {
         ...
         */
        application: Schema.Aliased<"filter" | "other" | "validation" | "restraint" | "representation" | "sampling" | "modeling">;
        /**
    ...
    ihm_dataset_related_db_reference: {
         ...
         */
        db_name: Schema.Aliased<"BMRB" | "EMDB" | "PDB" | "PDB-Dev" | "SASBDB" | "Other" | "EMPIAR" | "PRIDE" | "MODEL ARCHIVE" | "MASSIVE" | "BioGRID" | "ProXL" | "jPOSTrepo" | "iProX" | "AlphaFoldDB" | "ProteomeXchange" | "BMRbig">;
        /**
         * The accession code for the database entry.
         */
        accession_code: Schema.Str;
        /**
    ...
    ihm_external_reference_info: {
         ...
         */
        reference_id: Schema.Int;
        /**
         * The name of the reference provider.
         */
        reference_provider: Schema.Str;
        /**
         ...
         */
        reference_type: Schema.Aliased<"DOI" | "Supplementary Files">;
        /**
         ...
         */
        refers_to: Schema.Aliased<"Other" | "File" | "Archive" | "Publication">;
        /**
    ...
    ihm_external_files: {
         ...
         */
        file_path: Schema.Str;
        /**
         * The type of content in the file.
         */
        content_type: Schema.Aliased<"Other" | "Input data or restraints" | "Modeling or post-processing output" | "Modeling workflow or script" | "Visualization script">;
        /**
         * Storage size of the external file in bytes.
         */
        file_size_bytes: Schema.Float;
        /**
    ...
    ihm_predicted_contact_restraint: {
         ...
         */
        restraint_type: Schema.Aliased<"lower bound" | "upper bound" | "lower and upper bound">;
        /**
         * The granularity of the predicted contact as applied to the multi-scale model.
         */
        model_granularity: Schema.Aliased<"by-residue" | "by-feature">;
        /**
    ...
    ihm_cross_link_list: {
         ...
         */
        entity_description_1: Schema.Str;
        /**
         * A text description of molecular entity 2.
         */
        entity_description_2: Schema.Str;
        /**
         ...
         */
        linker_type: Schema.Aliased<"Other" | "EDC" | "DSS" | "EGS" | "BS3" | "BS2G" | "DST" | "sulfo-SDA" | "sulfo-SMCC" | "DSSO" | "DSG" | "BSP" | "BMSO" | "DHSO" | "CYS" | "SDA" | "DSA" | "BrdU" | "LCSDA" | "CDI" | "ADH" | "L-Photo-Leucine" | "KArGO" | "BrEtY" | "DSBU" | "DSPP" | "TBDSPP" | "DMTMM" | "PDH">;
        /**
    ...
    ihm_cross_link_restraint: {
         ...
         */
        restraint_type: Schema.Aliased<"lower bound" | "upper bound" | "harmonic">;
        /**
         * The cross link conditionality.
         */
        conditional_crosslink_flag: Schema.Aliased<"ALL" | "ANY">;
        /**
         * The coarse-graining information for the crosslink implementation.
         */
        model_granularity: Schema.Aliased<"by-atom" | "by-residue" | "by-feature">;
        /**
         * The distance threshold applied to this crosslink in the integrative modeling task.
         */
        distance_threshold: Schema.Float;
        /**
    ...
    ihm_2dem_class_average_restraint: {
         ...
         */
        number_raw_micrographs: Schema.Int;
        /**
         ...
         */
        pixel_size_height: Schema.Float;
        /**
         * Resolution of the 2dem class average.
         */
        image_resolution: Schema.Float;
        /**
         ...
         */
        number_of_projections: Schema.Int;
        /**
    ...
    ihm_3dem_restraint: {
         ...
         */
        number_of_gaussians: Schema.Int;
        /**
    ...
    ihm_gaussian_obj_site: {
         ...
         */
        covariance_matrix: Schema.Tensor;
        /**
    ...
    ihm_derived_distance_restraint: {
         ...
         */
        group_conditionality: Schema.Aliased<"ALL" | "ANY">;
        /**
         ...
         */
        random_exclusion_fraction: Schema.Float;
        /**
         ...
         * The type of distance restraint applied.
         */
        restraint_type: Schema.Aliased<"lower bound" | "upper bound" | "lower and upper bound" | "harmonic">;
        /**
    ...
    ma_qa_metric: {
         ...
         */
        type: Schema.Aliased<"boolean" | "other" | "zscore" | "energy" | "distance" | "normalized score" | "pLDDT" | "pLDDT in [0,1]" | "pLDDT all-atom" | "pLDDT all-atom in [0,1]" | "pLDDT to polymer" | "PAE" | "pTM" | "ipTM" | "contact probability">;
        /**
         * The mode of calculation of the QA metric.
         */
        mode: Schema.Aliased<"local" | "global" | "local-pairwise" | "per-feature" | "per-feature-pair">;
        /**
