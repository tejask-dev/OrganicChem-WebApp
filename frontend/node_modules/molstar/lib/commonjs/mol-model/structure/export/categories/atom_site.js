...
const atom_site_fields = (keepId) => {
    ...
    fields.str('group_PDB', structure_1.StructureProperties.residue.group_PDB);
    if (keepId) {
        fields.int('id', structure_1.StructureProperties.atom.id);
    }
    else {
        fields.index('id');
    }
