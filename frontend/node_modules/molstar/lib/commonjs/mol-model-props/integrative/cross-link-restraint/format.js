...
exports.ModelCrossLinkRestraint = void 0;
...
(function (ModelCrossLinkRestraint) {
    ...
    ModelCrossLinkRestraint.Provider = property_1.FormatPropertyProvider.create(ModelCrossLinkRestraint.Descriptor);
    function fromTable(table, model) {
        ...
        function getMapByKind(kind) {
            switch (kind) {
                case structure_1.Unit.Kind.Atomic: return atomicElementMap;
                case structure_1.Unit.Kind.Spheres: return sphereElementMap;
                case structure_1.Unit.Kind.Gaussians: return gaussianElementMap;
            }
        }
...
})(ModelCrossLinkRestraint || (exports.ModelCrossLinkRestraint = ModelCrossLinkRestraint = {}));
