...
(function (IndexedCustomProperty) {
    ...
    function fromResidueMap(map) {
        return new SegmentedMappedIndexedCustomProperty('residue', map, getResidueSegments, structure_1.Unit.Kind.Atomic);
    }
    IndexedCustomProperty.fromResidueMap = fromResidueMap;
    function fromResidueArray(array) {
        // TODO: create "array based custom property" as optimization
        return new SegmentedMappedIndexedCustomProperty('residue', arrayToMap(array), getResidueSegments, structure_1.Unit.Kind.Atomic);
    }
    ...
    function fromChainMap(map) {
        return new SegmentedMappedIndexedCustomProperty('chain', map, getChainSegments, structure_1.Unit.Kind.Atomic);
    }
    IndexedCustomProperty.fromChainMap = fromChainMap;
    function fromChainArray(array) {
        // TODO: create "array based custom property" as optimization
        return new SegmentedMappedIndexedCustomProperty('chain', arrayToMap(array), getChainSegments, structure_1.Unit.Kind.Atomic);
    }
...
class ElementMappedCustomProperty {
    ...
    constructor(map) {
        ...
        this.id = mol_util_1.UUID.create22();
        this.level = 'atom';
        this.kind = structure_1.Unit.Kind.Atomic;
    }
}
