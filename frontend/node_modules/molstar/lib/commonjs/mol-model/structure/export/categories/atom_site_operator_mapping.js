...
const asmValueKind = (i, xs) => typeof xs[i].operator.assembly === 'undefined' ? db_1.Column.ValueKinds.NotPresent : db_1.Column.ValueKinds.Present;
const symmetryValueKind = (i, xs) => xs[i].operator.spgrOp === -1 ? db_1.Column.ValueKinds.NotPresent : db_1.Column.ValueKinds.Present;
...
function getEntries(ctx) {
    ...
    for (const s of ctx.structures) {
        ...
        for (const unit of s.units) {
            ...
            if (!operator.suffix || unit.kind !== unit_1.Unit.Kind.Atomic)
                continue;
            l.unit = unit;
            const { elements } = unit;
