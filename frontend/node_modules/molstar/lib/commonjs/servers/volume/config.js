...
exports.LimitsConfig = exports.ServerConfig = void 0;
...
exports.ServerConfig = { ...DefaultServerConfig };
function setServerConfig(config) {
    for (const k of (0, type_helpers_1.ObjectKeys)(exports.ServerConfig)) {
        if (config[k] !== void 0)
...
exports.LimitsConfig = { ...DefaultLimitsConfig };
function setLimitsConfig(config) {
    for (const k of (0, type_helpers_1.ObjectKeys)(exports.LimitsConfig)) {
        if (config[k] !== void 0)
...
function configureServer() {
    ...
    try {
        ...
        if (config.printCfg) {
            console.log(JSON.stringify({ ...exports.ServerConfig, ...exports.LimitsConfig }, null, 2));
            process.exit(0);
        }
