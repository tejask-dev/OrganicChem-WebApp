...
exports.GeometryQualityColorThemeProvider = void 0;
...
const DefaultColor = (0, color_1.Color)(0x909090);
const NoIssuesColor = (0, color_1.Color)(0x2166ac);
const OneIssueColor = (0, color_1.Color)(0xfee08b);
const TwoIssuesColor = (0, color_1.Color)(0xf46d43);
const ThreeOrMoreIssuesColor = (0, color_1.Color)(0xa50026);
...
function GeometryQualityColorTheme(ctx, props) {
    ...
    if (value && model) {
        ...
        const getColor = (element) => {
            ...
            if (count > 0 && polymerType[rI] === types_1.PolymerType.NA) {
                count = 0;
