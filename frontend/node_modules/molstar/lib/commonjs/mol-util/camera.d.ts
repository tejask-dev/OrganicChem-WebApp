...
export declare function fovAdjustedPosition(target: Vec3, refPosition: Vec3, mode: Camera.Mode, fov: number): Vec3;
/** Return the inverse of fovAdjustedPosition to be able to store invariant camera position,
 * e.g., in MolViewSpec snapshots.
 */
export declare function fovNormalizedCameraPosition(target: Vec3, refPosition: Vec3, mode: Camera.Mode, fov: number): Vec3;
