...
const UnpackFactors = Vec4.create(UnpackDownscale / PackFactors[0], UnpackDownscale / PackFactors[1], UnpackDownscale / PackFactors[2], UnpackDownscale / 1);
...
export function arrayMaxPackedIntToRGB(array, stride) {
    let max = -Infinity;
