...
import { AttributeSpec, Values, UniformSpec, TextureSpec, ElementsSpec, DefineSpec, ValueSpec } from './schema';
...
export declare function DirectVolumeRenderable(ctx: WebGLContext, id: number, values: DirectVolumeValues, state: RenderableState, materialId: number, transparency: Transparency): Renderable<DirectVolumeValues>;
