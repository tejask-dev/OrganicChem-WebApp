...
export class VolumeSourceControls extends CollapsableControls {
    ...
    renderControls() {
        ...
        const mng = this.plugin.managers.volume.hierarchy;
        const { current } = mng;
        return _jsxs(_Fragment, { children: [_jsxs("div", { className: 'msp-flex-row', style: { marginTop: '1px' }, children: [_jsx(Button, { noOverflow: true, flex: true, onClick: this.toggleHierarchy, disabled: disabled, title: label, children: label }), !this.isEmpty && selected && _jsx(IconButton, { svg: AddSvg, onClick: this.toggleAddRepr, title: 'Apply a structure presets to the current hierarchy.', toggleState: this.state.show === 'add-repr', disabled: disabled }), !this.isEmpty && _jsx(IconButton, { svg: VisibilityOutlinedSvg, onClick: this.toggleVisibility, toggleState: false, title: 'Toggle visibility of all volumes.', disabled: disabled })] }), this.state.show === 'hierarchy' && _jsx(ActionMenu, { items: this.hierarchyItems, onSelect: this.selectCurrent }), this.state.show === 'add-repr' && _jsx(ActionMenu, { items: this.addActions, onSelect: this.selectAdd }), current.volumes.length > 0 && _jsx("div", { style: { marginTop: '6px' }, children: current.volumes.map((volume) => _jsx(VolumeEntryControls, { volume: volume }, volume.cell.transform.ref)) })] });
    }
}
function VolumeEntryControls({ volume }) {
    var _a, _b;
    return _jsxs(_Fragment, { children: [_jsx("div", { className: 'msp-control-group-header', style: { marginTop: '1px' }, children: _jsx("div", { children: _jsx("b", { children: (_b = (_a = volume.cell.obj) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : 'n/a' }) }) }), volume.representations.map(r => _jsx(VolumeRepresentationControls, { volume: volume, representation: r }, r.cell.transform.ref))] });
}
class VolumeRepresentationControls extends PurePluginUIComponent {
    constructor() {
        ...
        this.requestIsoValueUpdate = (values) => {
            this.updateIsoValueEvent.next(values);
        };
        this.updateIsoValue = (values) => {
            var _a, _b;
            const t = this.props.representation.cell.transform;
            return this.plugin.build().to(t.ref).update({
                ...t.params,
                type: {
                    ...(_a = t.params) === null || _a === void 0 ? void 0 : _a.type,
                    params: {
                        ...(_b = t.params) === null || _b === void 0 ? void 0 : _b.type.params,
