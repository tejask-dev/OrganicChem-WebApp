...
const axes3d_1 = require("../../geometry/primitives/axes3d");
...
(function (PrincipalAxes) {
    ...
    function calculateMomentsAxes(positions) {
        if (positions.length === 3) {
            return axes3d_1.Axes3D.create(vec3_1.Vec3.fromArray((0, vec3_1.Vec3)(), positions, 0), vec3_1.Vec3.create(1, 0, 0), vec3_1.Vec3.create(0, 1, 0), vec3_1.Vec3.create(0, 0, 1));
        }
    ...
    function calculateBoxAxes(positions, momentsAxes) {
        if (positions.length === 3) {
            return axes3d_1.Axes3D.clone(momentsAxes);
        }
        let d1a = -Infinity;
        let d1b = -Infinity;
        let d2a = -Infinity;
