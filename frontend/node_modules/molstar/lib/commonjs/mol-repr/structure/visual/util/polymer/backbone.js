...
function eachPolymerBackboneLink(unit, callback) {
    switch (unit.kind) {
        case structure_1.Unit.Kind.Atomic: return eachAtomicPolymerBackboneLink(unit, callback);
...
function eachPolymerBackboneElement(unit, callback) {
    switch (unit.kind) {
        case structure_1.Unit.Kind.Atomic: return eachAtomicPolymerBackboneElement(unit, callback);
        case structure_1.Unit.Kind.Spheres:
        case structure_1.Unit.Kind.Gaussians:
