...
function createGaussianSurfaceTextureMesh(ctx, unit, structure, theme, props, textureMesh) {
    ...
    const create = (textureMesh) => {
        ...
        const densityTextureData = (0, gaussian_1.computeUnitGaussianDensityTexture2d)(structure, unit, theme.size, true, props, webgl, namedTextures[GaussianSurfaceName]);
