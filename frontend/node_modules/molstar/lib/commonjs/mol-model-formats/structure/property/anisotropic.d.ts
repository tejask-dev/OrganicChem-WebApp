...
declare namespace AtomSiteAnisotrop {
    ...
    function getElementToAnsiotrop(atomId: Column<number>, ansioId: Column<number>): Int32Array<ArrayBuffer>;
    function getElementToAnsiotropFromLabel(atomLabel: Column<string>, ansioLabel: Column<string>): Int32Array<ArrayBuffer>;
}
