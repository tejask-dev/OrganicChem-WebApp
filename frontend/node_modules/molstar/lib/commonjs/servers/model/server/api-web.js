...
function initWebApi(app) {
    ...
    app.post(makePath('v1/query-many'), (req, res) => {
        ...
        req.setTimeout(config_1.ModelServerConfig.requestTimeoutMs);
        createMultiJob(params, res);
    });
    ...
    app.get(makePath('health-check'), (_, res) => (0, util_1.healthCheck)(res, config_1.ModelServerConfig.healthCheckPath));
