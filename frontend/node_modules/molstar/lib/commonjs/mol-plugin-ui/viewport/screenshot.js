...
function normalizedCameraPosition(camera) {
    if (!camera)
        return;
    return (0, camera_1.fovNormalizedCameraPosition)(camera.target, camera.position, camera.mode, camera.fov);
}
