...
exports.MembraneServerConfig = void 0;
...
const DefaultMembraneServerConfig = {
     ...
     */
    bcifSource: (id) => `https://models.rcsb.org/${id}.bcif`,
};
...
exports.MembraneServerConfig = { ...DefaultMembraneServerConfig };
function setConfig(config) {
    for (const k of (0, type_helpers_1.ObjectKeys)(exports.MembraneServerConfig)) {
        if (config[k] !== void 0)
            exports.MembraneServerConfig[k] = config[k];
    }
}
function parseConfigArguments() {
    const parser = new argparse.ArgumentParser({
        add_help: true,
        description: `Mol* MembraneServer ${version_1.VERSION}, (c) 2024, Mol* contributors`
    });
