        ...
        for (let ni = 0; ni < count; ni++) {
            ...
            if (dist <= pairingThreshold) {
                ...
                builder.add(_aI, _bI, {
                    ...
                    flag: (isMetal ? types_1.BondType.Flag.MetallicCoordination : types_1.BondType.Flag.Covalent) | types_1.BondType.Flag.Computed,
                    key: -1
                });
            }
        }
...
function computeInterUnitBonds(structure, props) {
    ...
    return findBonds(structure, {
        ...
        validUnitPair: (props && props.validUnitPair) || ((s, a, b) => {
            ...
            const notWater = ((!unit_1.Unit.isAtomic(a) || mtA[a.residueIndex[a.elements[0]]] !== types_1.MoleculeType.Water) &&
                (!unit_1.Unit.isAtomic(b) || mtB[b.residueIndex[b.elements[0]]] !== types_1.MoleculeType.Water));
            const notIonA = (!unit_1.Unit.isAtomic(a) || mtA[a.residueIndex[a.elements[0]]] !== types_1.MoleculeType.Ion);
            const notIonB = (!unit_1.Unit.isAtomic(b) || mtB[b.residueIndex[b.elements[0]]] !== types_1.MoleculeType.Ion);
