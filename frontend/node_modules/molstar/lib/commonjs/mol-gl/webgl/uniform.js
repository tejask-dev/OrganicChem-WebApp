...
exports.isArrayUniform = isArrayUniform;
...
function getUniformType(gl, kind) {
    switch (kind) {
        ...
        case 'q':
        case 'q[]': return gl.FLOAT_VEC4;
        case 'iv2':
        case 'iv2[]': return gl.INT_VEC2;
        case 'iv3':
        case 'iv3[]': return gl.INT_VEC3;
        case 'iv4':
        case 'iv4[]': return gl.INT_VEC4;
        case 'm3':
...
function uniform2iv(gl, location, value) { gl.uniform2iv(location, value); }
function uniform3iv(gl, location, value) { gl.uniform3iv(location, value); }
function uniform4iv(gl, location, value) { gl.uniform4iv(location, value); }
...
function getUniformSetter(kind) {
    switch (kind) {
        ...
        case 'q':
        case 'q[]': return uniform4fv;
        case 'iv2':
        case 'iv2[]': return uniform2iv;
        case 'iv3':
        case 'iv3[]': return uniform3iv;
        case 'iv4':
        case 'iv4[]': return uniform4iv;
        case 'm3':
