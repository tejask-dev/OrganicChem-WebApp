...
export type DataResponse<T extends DataType> = T extends 'json' ? any : T extends 'xml' ? XMLDocument : T extends 'string' ? StringLike : T extends 'binary' ? Uint8Array : T extends 'zip' ? {
    [k: string]: Uint8Array;
} : never;
...
export declare function readUint8ArrayFromFile(file: File): Task<Uint8Array<ArrayBufferLike>>;
