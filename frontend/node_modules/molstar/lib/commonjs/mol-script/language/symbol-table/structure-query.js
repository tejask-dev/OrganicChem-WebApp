...
const atomProperty = {
    ...
    ihm: {
        hasSeqId: (0, helpers_1.symbol)(symbol_1.Arguments.Dictionary({ 0: (0, symbol_1.Argument)(type_1.Type.Num) }), type_1.Type.Bool, 'Checks if the current element represents a given sequence id'),
        overlapsSeqIdRange: (0, helpers_1.symbol)(symbol_1.Arguments.Dictionary({ beg: (0, symbol_1.Argument)(type_1.Type.Num), end: (0, symbol_1.Argument)(type_1.Type.Num) }), type_1.Type.Bool, 'Checks if the current element overlaps with the specified residue range'),
    },
};
const bondProperty = {
