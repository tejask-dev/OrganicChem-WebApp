    ...
    const builderProps = {
        ...
        position: (posA, posB, edgeIndex) => {
            ...
            if ((!ignoreHydrogens || ignoreHydrogensVariant !== 'all') && (t === common_3.InteractionType.HydrogenBond || (t === common_3.InteractionType.WeakHydrogenBond && ignoreHydrogensVariant !== 'non-polar'))) {
                ...
                const donorType = t === common_3.InteractionType.HydrogenBond ? common_1.FeatureType.HydrogenDonor : common_1.FeatureType.WeakHydrogenDonor;
        ...
        style: (edgeIndex) => link_1.LinkStyle.Dashed,
        radius: (edgeIndex) => {
