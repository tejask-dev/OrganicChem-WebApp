...
export const ModelServerFetchFormats = ['cif', 'bcif', 'cif.gz', 'bcif.gz'];
export let mapSourceAndIdToFilename = () => {
...
export const ModelServerConfigTemplate = {
...
function setConfig(config) {
    ...
    if (config.sourceMapUrl) {
        ...
        ModelServerConfig.sourceMap.push(...config.sourceMapUrl);
    }
}
