...
(function (CifField) {
    ...
    function ofNumbers(values) {
        ...
        const valueKind = row => db_1.Column.ValueKinds.Present;
...
function getCifFieldType(field) {
    ...
    for (let i = 0, _i = field.rowCount; i < _i; i++) {
        ...
        if (k !== db_1.Column.ValueKinds.Present) {
            undefinedCount++;
            continue;
        }
        const type = (0, number_parser_1.getNumberType)(field.str(i));
        if (type === number_parser_1.NumberTypes.Int)
            continue;
        else if (type === number_parser_1.NumberTypes.Float)
            floatCount++;
        else {
