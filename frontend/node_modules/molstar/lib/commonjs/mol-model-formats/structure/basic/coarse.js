...
const coarse_index_1 = require("../../../mol-model/structure/model/properties/utils/coarse-index");
...
function getCoarse(data, chemicalComponentMap) {
    ...
    return {
        hierarchy: {
            ...
            index: (0, coarse_index_1.getCoarseIndex)({ spheres: sphereData, gaussians: gaussianData })
        },
        conformation: {
