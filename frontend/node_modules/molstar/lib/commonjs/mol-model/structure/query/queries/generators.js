...
function atomGroupsSegmented({ unitTest, entityTest, chainTest, residueTest, atomTest }) {
    return function query_atomGroupsSegmented(ctx) {
        ...
        for (const unit of units) {
            ...
            builder.beginUnit(unit.id);
            if (unit.kind === structure_1.Unit.Kind.Atomic) {
                ...
                const { chainElementSegments } = unit.kind === structure_1.Unit.Kind.Spheres ? model.coarseHierarchy.spheres : model.coarseHierarchy.gaussians;
