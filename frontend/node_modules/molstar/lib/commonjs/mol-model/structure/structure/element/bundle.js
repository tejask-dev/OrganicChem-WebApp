...
(function (Bundle) {
    ...
    function fromExpression(structure, expression, queryContext) {
        return fromLoci(loci_1.Loci.fromExpression(structure, expression, queryContext));
    }
    Bundle.fromExpression = fromExpression;
    function fromQuery(structure, query, queryContext) {
        return fromLoci(loci_1.Loci.fromQuery(structure, query, queryContext));
    }
    Bundle.fromQuery = fromQuery;
    function fromSchema(structure, schema, queryContext) {
        return schema_1.Schema.toBundle(structure, schema, queryContext);
    }
