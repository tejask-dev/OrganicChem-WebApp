...
exports.Encoder = exports.Category = exports.Field = void 0;
...
(function (Field) {
    ...
    Field.float = float;
    function index(name) {
        return int(name, (e, d, i) => i + 1, { typedArray: Int32Array, encoder: binary_cif_1.ArrayEncoding.by(binary_cif_1.ArrayEncoding.delta).and(binary_cif_1.ArrayEncoding.runLength).and(binary_cif_1.ArrayEncoding.integerPacking) });
    }
    Field.index = index;
    class Builder {
        constructor() {
    ...
    function ofTable(table, indices) {
        if (indices) {
            return {
                ...
                source: [{ data: table, rowCount: indices.length, keys: () => iterator_1.Iterator.Array(indices) }]
            };
        }
        return {
            fields: cifFieldsFromTableSchema(table._schema),
