...
export declare const ImageSchema: {
    ...
    tValueTex: TextureSpec<"image-float32">;
...
export declare function ImageRenderable(ctx: WebGLContext, id: number, values: ImageValues, state: RenderableState, materialId: number, transparency: Transparency): Renderable<ImageValues>;
