...
declare const StructureProperties: {
    ...
    entity: {
        ...
        pdbx_parent_entity_id: StructureElement.Property<string>;
    ...
    unit: {
        ...
        hkl: StructureElement.Property<import("../../../mol-math/linear-algebra").Vec3>;
    ...
    coarse: {
        ...
        gaussian_covariance_matrix: StructureElement.Property<import("../../../mol-math/linear-algebra").Mat3>;
    };
};
