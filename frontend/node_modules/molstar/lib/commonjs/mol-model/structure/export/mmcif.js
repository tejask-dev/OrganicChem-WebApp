...
const molstar_bond_site_1 = require("./categories/molstar_bond_site");
...
const Categories = (options) => [
    ...
    // Atoms
    (0, atom_site_1._atom_site)({ keepId: options === null || options === void 0 ? void 0 : options.keepAtomSiteId }),
];
var _Filters;
(function (_Filters) {
...
function encode_mmCIF_categories_default(encoder, ctx, params) {
    ...
    if ((_c = params === null || params === void 0 ? void 0 : params.extensions) === null || _c === void 0 ? void 0 : _c.molstar_bond_site) {
        const info = (0, molstar_bond_site_1.molstar_bond_site)(ctx);
        if (info)
            encoder.writeCategory(info[0], info[1], info[2]);
    }
...
function to_mmCIF(name, structure, asBinary = false, params) {
    var _a;
    const enc = (_a = params === null || params === void 0 ? void 0 : params.encoder) !== null && _a !== void 0 ? _a : cif_1.CifWriter.createEncoder({ binary: asBinary });
