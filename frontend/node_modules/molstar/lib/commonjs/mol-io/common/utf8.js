...
exports.utf8ReadLong = utf8ReadLong;
exports.utf8ByteCount = utf8ByteCount;
const string_like_1 = require("./string-like");
...
function utf8ReadLong(data, offset = 0, length = data.length) {
    if (length <= string_like_1.MAX_STRING_LENGTH) {
        return utf8Read(data, offset, length);
    }
    const out = string_like_1.ChunkedBigString.fromUtf8Data(data, offset, offset + length);
    return out.length <= string_like_1.MAX_STRING_LENGTH ? out.toString() : out;
}
