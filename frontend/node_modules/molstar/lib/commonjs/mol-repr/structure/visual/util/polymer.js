...
function getPolymerRanges(unit) {
    switch (unit.kind) {
        case structure_1.Unit.Kind.Atomic: return unit.model.atomicRanges.polymerRanges;
        case structure_1.Unit.Kind.Spheres: return unit.model.coarseHierarchy.spheres.polymerRanges;
        case structure_1.Unit.Kind.Gaussians: return unit.model.coarseHierarchy.gaussians.polymerRanges;
    }
}
function getGapRanges(unit) {
    switch (unit.kind) {
        case structure_1.Unit.Kind.Atomic: return unit.model.atomicRanges.gapRanges;
        case structure_1.Unit.Kind.Spheres: return unit.model.coarseHierarchy.spheres.gapRanges;
        case structure_1.Unit.Kind.Gaussians: return unit.model.coarseHierarchy.gaussians.gapRanges;
    }
}
            ...
            if (unitIdx !== undefined) {
                int_1.OrderedSet.forEach(e.indices, v => {
                    ...
                    if (idx !== -1) {
                        ...
                        if (int_1.OrderedSet.getAt(e.unit.gapElements, idx + 1) === e.unit.elements[v]) {
                            if (apply(int_1.Interval.ofSingleton(unitIdx * groupCount + idx + 1)))
                                changed = true;
                        }
                    }
                });
