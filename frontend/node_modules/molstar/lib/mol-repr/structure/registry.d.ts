...
export declare namespace StructureRepresentationRegistry {
    export const BuiltIn: {
        ...
        plane: import("./representation").StructureRepresentationProvider<{
            visuals: import("../../mol-util/param-definition").ParamDefinition.MultiSelect<"plane-image">;
            interpolation: import("../../mol-util/param-definition").ParamDefinition.Select<"nearest" | "catmulrom" | "mitchell" | "bspline">;
            imageResolution: import("../../mol-util/param-definition").ParamDefinition.Numeric;
            mode: import("../../mol-util/param-definition").ParamDefinition.Select<"frame" | "plane">;
            ...
            plane: import("../../mol-util/param-definition").ParamDefinition.Group<import("../../mol-util/param-definition").ParamDefinition.Normalize<{
                point: import("../../mol-math/linear-algebra").Vec3;
                normal: import("../../mol-math/linear-algebra").Vec3;
            }>>;
            extent: import("../../mol-util/param-definition").ParamDefinition.Select<"frame" | "sphere">;
            margin: import("../../mol-util/param-definition").ParamDefinition.Numeric;
            frame: import("../../mol-util/param-definition").ParamDefinition.Select<"principalAxes" | "boundingBox">;
            antialias: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
            cutout: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
            defaultColor: import("../../mol-util/param-definition").ParamDefinition.Color;
            includeParent: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
            unitKinds: import("../../mol-util/param-definition").ParamDefinition.MultiSelect<"spheres" | "gaussians" | "atomic">;
            alpha: import("../../mol-util/param-definition").ParamDefinition.Numeric;
            quality: import("../../mol-util/param-definition").ParamDefinition.Select<"auto" | "medium" | "high" | "low" | "custom" | "highest" | "higher" | "lower" | "lowest">;
        ...
        point: import("./representation").StructureRepresentationProvider<{
            density: import("../../mol-util/param-definition").ParamDefinition.Numeric;
            visuals: import("../../mol-util/param-definition").ParamDefinition.MultiSelect<"element-point" | "structure-element-point">;
            pointSizeAttenuation: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
            ignoreHydrogens: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
            ignoreHydrogensVariant: import("../../mol-util/param-definition").ParamDefinition.Select<"all" | "non-polar">;
            traceOnly: import("../../mol-util/param-definition").ParamDefinition.BooleanParam;
