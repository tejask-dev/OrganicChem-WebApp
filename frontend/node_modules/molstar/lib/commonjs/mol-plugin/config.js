...
exports.PluginConfig = {
    ...
    General: {
        ...
        Transparency: item('plugin-config.transparency', features_1.PluginFeatureDetection.defaultTransparency),
    ...
    VolumeStreaming: {
        ...
        CanStream: item('volume-streaming.can-stream', (s, plugin) => {
            return s.models.length === 1 && structure_1.Model.probablyHasDensityMap(s.models[0]);
        }),
