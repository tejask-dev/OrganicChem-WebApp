    ...
    for (let i = 0; i < n; i++) {
        const conn = {
            ...
            partner1: {
                ...
                seqId: seq1.valueKind(i) === db_1.Column.ValueKinds.Present ? seq1.value(i) : undefined,
                authSeqId: authSeq1.valueKind(i) === db_1.Column.ValueKinds.Present ? authSeq1.value(i) : undefined,
            ...
            partner2: {
                ...
                seqId: seq2.valueKind(i) === db_1.Column.ValueKinds.Present ? seq2.value(i) : undefined,
                authSeqId: authSeq2.valueKind(i) === db_1.Column.ValueKinds.Present ? authSeq2.value(i) : undefined,
