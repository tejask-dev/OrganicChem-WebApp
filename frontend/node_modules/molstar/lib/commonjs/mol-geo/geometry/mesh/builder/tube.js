...
const capNormalSmoothingVector = (0, linear_algebra_1.Vec3)();
const surfacePoint = (0, linear_algebra_1.Vec3)();
const controlPoint = (0, linear_algebra_1.Vec3)();
const u = (0, linear_algebra_1.Vec3)();
...
const CosSinCache = new Map();
function getCosSin(radialSegments, shift) {
    const offset = shift ? 1 : 0;
    const hash = (0, util_1.cantorPairing)(radialSegments, offset);
