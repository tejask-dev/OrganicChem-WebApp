...
const symmetry_operator_1 = require("../../geometry/symmetry-operator");
var SpacegroupCell;
...
(function (Spacegroup) {
    ...
    function getSymmetryOperator(spacegroup, spgrOp, i, j, k) {
        ...
        return symmetry_operator_1.SymmetryOperator.create(`${spgrOp + 1}_${5 + i}${5 + j}${5 + k}`, operator, { hkl: linear_algebra_1.Vec3.create(i, j, k), spgrOp });
    }
