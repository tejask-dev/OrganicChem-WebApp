...
import { addLinkCylinderMesh, DefaultLinkCylinderProps, LinkStyle } from '../../mol-repr/structure/visual/util/link';
    ...
    for (const interaction of interactions.elements) {
        ...
        if (interaction.info.kind === 'hydrogen-bond' || interaction.info.kind === 'weak-hydrogen-bond') {
            ...
            if (interaction.info.kind !== 'covalent') {
                ...
                if (degree === 'aromatic')
                    addLinkParams.linkStyle = LinkStyle.Aromatic;
                else if (degree === 2)
                    addLinkParams.linkStyle = LinkStyle.Double;
                else if (degree === 3)
                    addLinkParams.linkStyle = LinkStyle.Triple;
                else
                    addLinkParams.linkStyle = LinkStyle.Solid;
                addLinkParams.a = pA;
                addLinkParams.b = pB;
