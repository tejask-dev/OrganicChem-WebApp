...
function ViewportSnapshotDescription() {
    ...
    return (0, jsx_runtime_1.jsx)("div", { id: 'snapinfo', className: 'msp-snapshot-description-wrapper', children: e.descriptionFormat === 'plaintext'
            && e.description
            || (0, jsx_runtime_1.jsx)(react_markdown_1.default, { skipHtml: true, components: { a: MarkdownAnchor }, children: e.description }) });
}
function MarkdownAnchor({ href, children, element }) {
    ...
    if (href[0] === '#') {
        ...
        return (0, jsx_runtime_1.jsx)("a", { href: href, target: '_blank', rel: 'noopener noreferrer', children: children });
    }
