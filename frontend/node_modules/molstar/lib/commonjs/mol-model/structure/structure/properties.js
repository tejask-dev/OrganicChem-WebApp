...
const residue = {
    ...
    secondary_structure_type: p(l => {
        ...
        return secStruc ? secStruc.type[secStruc.getIndex(l.unit.residueIndex[l.element])] : types_1.SecondaryStructureType.Flag.NA;
    }),
