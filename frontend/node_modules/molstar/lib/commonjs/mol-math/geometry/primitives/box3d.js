...
(function (Box3D) {
    ...
    function expandUniformly(out, box, delta) {
        vec3_1.Vec3.subScalar(out.min, box.min, delta);
        vec3_1.Vec3.addScalar(out.max, box.max, delta);
        return out;
    }
    ...
    function center(out, box) {
        return vec3_1.Vec3.center(out, box.max, box.min);
    }
    Box3D.center = center;
    function exactEquals(a, b) {
        return vec3_1.Vec3.exactEquals(a.min, b.min) && vec3_1.Vec3.exactEquals(a.max, b.max);
    }
    Box3D.exactEquals = exactEquals;
    function equals(a, b) {
        return vec3_1.Vec3.equals(a.min, b.min) && vec3_1.Vec3.equals(a.max, b.max);
    }
    Box3D.equals = equals;
