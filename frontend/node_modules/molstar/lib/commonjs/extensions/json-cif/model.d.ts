...
export declare const JSONCifVERSION = "0.1.0";
...
export declare function getJSONCifCategory<S extends Table.Schema>(block: JSONCifDataBlock, name: string): JSONCifCategory<Table.Row<S>> | undefined;
