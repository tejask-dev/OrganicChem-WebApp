...
function mapToKind(flag) {
    if (flag === types_1.SecondaryStructureType.Flag.Helix) {
        return 'helix';
    }
    else if (flag === types_1.SecondaryStructureType.Flag.Beta) {
        return 'sheet';
    }
    else {
        return 'none';
