...
export function getMultiDraw(gl) {
...
export function getDrawInstancedBaseVertexBaseInstance(gl) {
...
export function getMultiDrawInstancedBaseVertexBaseInstance(gl) {
...
export function getClipCullDistance(gl) {
    if (isWebGL2(gl)) {
...
export function getConservativeDepth(gl) {
    if (isWebGL2(gl)) {
...
export function getStencilTexturing(gl) {
    if (isWebGL2(gl)) {
...
export function getClipControl(gl) {
...
export function getRenderSnorm(gl) {
    if (isWebGL2(gl)) {
...
export function getRenderSharedExponent(gl) {
    if (isWebGL2(gl)) {
...
export function getTextureNorm16(gl) {
...
export function getDepthClamp(gl) {
