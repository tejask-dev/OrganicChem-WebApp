...
export function createVolumeCellLocationIterator(volume) {
...
//
export function getVolumeTexture2dLayout(dim, padding = 0) {
...
export function createVolumeTexture2d(volume, variant, padding = 0, type = 'byte') {
...
export function createVolumeTexture3d(volume, type = 'byte') {
    const { cells: { space, data }, stats: { max, min } } = volume.grid;
...
export function createSegmentTexture2d(volume, set, bbox, padding = 0) {
