...
export declare const CylindersSchema: {
    ...
    aScale: AttributeSpec<"float32">;
    aCap: AttributeSpec<"float32">;
    aColorMode: AttributeSpec<"float32">;
...
export declare function CylindersRenderable(ctx: WebGLContext, id: number, values: CylindersValues, state: RenderableState, materialId: number, transparency: Transparency): Renderable<CylindersValues>;
