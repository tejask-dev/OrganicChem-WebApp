...
function createPolymerTraceMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    while (polymerTraceIt.hasNext) {
        ...
        const isSheet = types_1.SecondaryStructureType.is(v.secStrucType, types_1.SecondaryStructureType.Flag.Beta);
        const isHelix = types_1.SecondaryStructureType.is(v.secStrucType, types_1.SecondaryStructureType.Flag.Helix);
