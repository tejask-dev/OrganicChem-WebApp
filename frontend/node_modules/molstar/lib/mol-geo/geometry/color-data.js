...
export function createColors(locationIt, positionIt, colorTheme, colorData) {
    ...
    if (colorTheme.palette) {
        ...
        ValueCell.update(data.uPaletteDefault, Color.toVec3Normalized(data.uPaletteDefault.ref.value, (_a = colorTheme.palette.defaultColor) !== null && _a !== void 0 ? _a : Color(0xCCCCCC)));
