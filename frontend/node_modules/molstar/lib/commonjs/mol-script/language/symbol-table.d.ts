...
declare const MolScriptSymbolTable: {
    ...
    structureQuery: {
        ...
        atomProperty: {
            ...
            ihm: {
                hasSeqId: MSymbol<import("./symbol").Arguments<import("./symbol").Arguments.PropTypes<{
                    0: import("./symbol").Argument<import("./type").Type.Value<number>>;
                }>>, import("./type").Type.OneOf<boolean>>;
                overlapsSeqIdRange: MSymbol<import("./symbol").Arguments<import("./symbol").Arguments.PropTypes<{
                    beg: import("./symbol").Argument<import("./type").Type.Value<number>>;
                    end: import("./symbol").Argument<import("./type").Type.Value<number>>;
                }>>, import("./type").Type.OneOf<boolean>>;
            };
        };
        bondProperty: {
