...
(function (StateBuilder) {
    ...
    class Root {
        ...
        to(refOrCellOrSelector) {
            const ref = typeof refOrCellOrSelector === 'string'
                ? refOrCellOrSelector
                : object_1.StateObjectCell.is(refOrCellOrSelector)
        ...
        delete(obj) {
            const ref = object_1.StateObjectRef.resolveRef(obj);
    ...
    class To {
        get editInfo() { return this.state.editInfo; }
        get selector() { return new object_1.StateObjectSelector(this.ref, this.state.state); }
        getApplyRoot() {
            return immutable_1.StateTree.getDecoratorRoot(this.state.tree, this.ref);
        }
        /**
        ...
        applyOrUpdateTagged(tags, tr, params, options) {
            ...
            while (true) {
                ...
                if (tr && transform_1.StateTransform.hasTags(tr, tags)) {
        ...
        update(paramsOrTransformer, provider) {
            ...
            if (provider) {
                ...
                params = (0, immer_1.produce)(old.params, provider);
            }
            else {
                params = typeof paramsOrTransformer === 'function'
                    ? (0, immer_1.produce)(this.state.tree.transforms.get(this.ref).params, paramsOrTransformer)
                    : paramsOrTransformer;
            }
        ...
        updateState(state) {
            ...
            if (transform_1.StateTransform.isStateChange(transform.state, state)) {
    ...
    StateBuilder.To = To;
})(StateBuilder || (exports.StateBuilder = StateBuilder = {}));
