...
exports.UpdateTarget = void 0;
exports.loadTreeVirtual = loadTreeVirtual;
exports.mvsRefTags = mvsRefTags;
...
function loadTreeVirtual(plugin, tree, loadingActions, context, options) {
    ...
    const stateSnapshot = { tree: mol_state_1.StateTree.toJSON(stateTree) };
    const pluginStateSnapshot = { id: mol_util_1.UUID.create22(), data: stateSnapshot };
...
function loadTreeInUpdate(updateRoot, tree, loadingActions, context, options) {
    ...
    (0, tree_utils_1.dfs)(tree, (node, parent) => {
        ...
        if (action) {
            if (updateParent) {
                ...
                if (msNode && node.ref) {
                    exports.UpdateTarget.tag(msNode, mvsRefTags(node.ref));
    ...
    for (const target of updateRoot.targetManager.allTargets) {
        exports.UpdateTarget.dependsOn(target, mvsRefMap);
    }
