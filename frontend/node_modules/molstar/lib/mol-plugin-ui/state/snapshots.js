...
function EditSnapshot({ entry, plugin, done }) {
    var _a, _b, _c;
    const [state, setState] = React.useState({ key: (_a = entry.key) !== null && _a !== void 0 ? _a : '', name: (_b = entry.name) !== null && _b !== void 0 ? _b : '', description: (_c = entry.description) !== null && _c !== void 0 ? _c : '', descriptionFormat: entry.descriptionFormat });
    const apply = () => {
