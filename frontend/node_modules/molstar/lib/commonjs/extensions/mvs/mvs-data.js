...
exports.MVSData = exports.GlobalMetadata = void 0;
...
exports.GlobalMetadata = {
    create(metadata) {
        return {
            ...metadata,
            version: `${exports.MVSData.SupportedVersion}`,
            timestamp: utcNowISO(),
        };
    },
};
exports.MVSData = {
    ...
    toPrettyString(mvsData) {
        ...
        const trees = mvsData.kind === 'multiple' ?
            mvsData.snapshots.map((s, i) => `[Snapshot #${i}]\n${(0, tree_utils_1.treeToString)(s.root)}`).join('\n')
    ...
    createMultistate(snapshots, metadata) {
        return {
            kind: 'multiple',
            snapshots: [...snapshots],
            metadata: exports.GlobalMetadata.create(metadata),
        };
    },
...
function snapshotValidationIssues(snapshot, options = {}) {
    ...
    return (0, tree_schema_1.treeValidationIssues)(mvs_tree_1.MVSTreeSchema, snapshot.root, options);
}
