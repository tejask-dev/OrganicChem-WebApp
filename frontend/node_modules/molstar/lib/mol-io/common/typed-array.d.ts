...
export declare function createTypedArray(type: TypedArrayValueType, size: number): Int8Array<ArrayBuffer> | Uint16Array<ArrayBuffer> | Int16Array<ArrayBuffer> | Float32Array<ArrayBuffer>;
