...
export declare const TextSchema: {
    ...
    dColorMarker: import("./schema").DefineSpec<"boolean">;
    ...
    dClippingType: import("./schema").DefineSpec<"string">;
...
export declare function TextRenderable(ctx: WebGLContext, id: number, values: TextValues, state: RenderableState, materialId: number, transparency: Transparency): Renderable<TextValues>;
