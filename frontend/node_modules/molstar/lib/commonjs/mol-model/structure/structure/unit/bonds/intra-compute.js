        ...
        for (let ni = 0; ni < count; ni++) {
            ...
            if (raI === rbI && componentPairs) {
                ...
                if (e) {
                    ...
                    let flag = e.flags;
                    if (isMetal) {
                        if (flag | types_1.BondType.Flag.Covalent)
            ...
            if (flag) {
                ...
                flags[flags.length] = (isMetal ? types_1.BondType.Flag.MetallicCoordination : types_1.BondType.Flag.Covalent) | types_1.BondType.Flag.Computed;
                key[key.length] = -1;
