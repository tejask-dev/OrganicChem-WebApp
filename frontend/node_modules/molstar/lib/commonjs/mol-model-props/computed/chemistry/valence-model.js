...
function isConjugated(structure, unit, index) {
    ...
    const hetero = element === types_1.Elements.O || element === types_1.Elements.N;
    ...
    while (tmpConjBondItA.hasNext) {
        ...
        if (hetero) {
            ...
            while (tmpConjBondItB.hasNext) {
                ...
                if (bB.order > 1) {
                    if ((elementB === types_1.Elements.P || elementB === types_1.Elements.S) &&
                        (0, util_1.typeSymbol)(bB.otherUnit, bB.otherIndex) === types_1.Elements.O) {
                        continue;
                    }
                    return true;
                }
...
function calculateHydrogensCharge(structure, unit, index, props, hasExplicitH) {
    const hydrogenCount = (0, util_1.bondToElementCount)(structure, unit, index, types_1.Elements.H);
    const element = (0, util_1.typeSymbol)(unit, index);
    ...
    switch (element) {
            ...
            if (assignCharge) {
                if (!assignH) { // Trust input H explicitly:
                    ...
                    while (tmpChargeBondItA.hasNext) {
                        ...
                        if (elementB === types_1.Elements.S || (0, types_1.isMetal)(elementB)) {
                            charge = 0;
                            break;
                        }
                        else {
        ...
        case types_1.Elements.S:
            if (assignCharge) {
                if (!assignH) {
                    if (valence <= 3 && (0, util_1.bondToElementCount)(structure, unit, index, types_1.Elements.O) === 0) {
            ...
            break;
        case types_1.Elements.F:
        case types_1.Elements.CL:
        case types_1.Elements.BR:
        case types_1.Elements.I:
        case types_1.Elements.AT:
            // Never implicitly protonate halides
            if (assignCharge) {
                charge = valence - 1;
            }
            break;
        case types_1.Elements.LI:
        case types_1.Elements.NA:
        case types_1.Elements.K:
        case types_1.Elements.RB:
        case types_1.Elements.CS:
        case types_1.Elements.FR:
            if (assignCharge) {
                charge = 1 - valence;
            }
            break;
        case types_1.Elements.BE:
        case types_1.Elements.MG:
        case types_1.Elements.CA:
        case types_1.Elements.SR:
        case types_1.Elements.BA:
        case types_1.Elements.RA:
            if (assignCharge) {
                charge = 2 - valence;
            }
            break;
...
function calcUnitValenceModel(structure, unit, props) {
    ...
    for (let i = 0; i < n; ++i) {
        ...
        if ((0, util_1.typeSymbol)(unit, j) === types_1.Elements.H) {
            hasExplicitH = true;
            break;
        }
    }
