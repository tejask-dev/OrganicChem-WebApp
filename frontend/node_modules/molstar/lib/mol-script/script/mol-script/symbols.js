...
export const SymbolTable = [
    ...
    [
        ...
        [
            ...
            }), StructureQueryTypes.ElementSelection, 'A selection of singleton atom sets.'), args => B.struct.generator.atomGroups({ 'atom-test': tryGetArg(args, 0, true) })),
            ...
            }), StructureQueryTypes.ElementSelection, 'A selection of atom sets grouped by residue.'), args => B.struct.generator.atomGroups({
            ...
            }), StructureQueryTypes.ElementSelection, 'A selection of atom sets grouped by chain.'), args => B.struct.generator.atomGroups({
