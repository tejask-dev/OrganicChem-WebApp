...
exports.UnitRings = exports.UnitRing = void 0;
const compute_1 = require("./rings/compute");
const int_1 = require("../../../../mol-data/int");
const types_1 = require("../../model/types");
const types_2 = require("../../model/properties/atomic/types");
...
class UnitRings {
    get index() {
        if (this._index)
            return this._index;
        this._index = (0, compute_1.createIndex)(this.all, this.aromaticRings);
        return this._index;
    }
    get byFingerprint() {
...
(function (UnitRing) {
    ...
    function elementFingerprint(elements) {
        return (0, compute_1.getFingerprint)(elements);
    }
    UnitRing.elementFingerprint = elementFingerprint;
    const AromaticRingElements = new Set([
        types_2.Elements.B, types_2.Elements.C, types_2.Elements.N, types_2.Elements.O,
        types_2.Elements.SI, types_2.Elements.P, types_2.Elements.S,
        types_2.Elements.GE, types_2.Elements.AS,
        types_2.Elements.SN, types_2.Elements.SB,
        types_2.Elements.BI
    ]);
    ...
    function isAromatic(unit, ring) {
        ...
        for (let i = 0, il = ring.length; i < il; ++i) {
            ...
            for (let j = offset[aI], jl = offset[aI + 1]; j < jl; ++j) {
                ...
                if (types_1.BondType.is(types_1.BondType.Flag.Aromatic, flags[j])) {
        ...
        if (aromaticBondCount > 0)
            return false;
        const ma = principal_axes_1.PrincipalAxes.calculateMomentsAxes((0, util_1.getPositions)(unit, ring));
...
})(UnitRing || (exports.UnitRing = UnitRing = {}));
(function (UnitRings) {
    function create(unit) {
        const rings = (0, compute_1.computeRings)(unit);
...
})(UnitRings || (exports.UnitRings = UnitRings = {}));
