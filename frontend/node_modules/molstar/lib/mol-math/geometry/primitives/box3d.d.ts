...
declare namespace Box3D {
    ...
    function set(out: Box3D, min: Vec3, max: Vec3): Box3D;
    ...
    function expandUniformly(out: Box3D, box: Box3D, delta: number): Box3D;
    ...
    function center(out: Vec3, box: Box3D): Vec3;
    function exactEquals(a: Box3D, b: Box3D): boolean;
    function equals(a: Box3D, b: Box3D): boolean;
}
export { Box3D };
